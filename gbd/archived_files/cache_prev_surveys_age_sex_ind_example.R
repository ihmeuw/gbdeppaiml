...
unique(data3[grepl("IND", iso3)]$admin_1_urban_id) 
loc.table[grepl("Rural", location_name), ihme_loc_id]
loc.table[grepl("Urban", location_name), ihme_loc_id]
...
data3 = data3[grepl("IND",loc_year)]
options(survey.lonely.psu="adjust")
loc.year = "IND_4844_2015"
