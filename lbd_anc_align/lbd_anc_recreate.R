...
output.dir <- '/ihme/hiv/data/PJNZ_EPPASM_prepped_subpop/lbd_anc/'
## Packages
library(data.table)
...
keep <- keep[-which(keep$years == 2013 | keep$years == 2015),]
...
colnames(lat_long_table)[2:3] <- c('latitude', 'longitude')
