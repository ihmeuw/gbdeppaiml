...
##
## ANC SNAP FUNCTIONS
## Author: Krista Steuben (steuben@uw.edu)
## 
...
snap_codebook <- function(codebook) {
  admin0 <- readOGR("/home/j/WORK/11_geospatial/05_survey shapefile library/Shapefile directory/global_rasterized_admin0.shp")
